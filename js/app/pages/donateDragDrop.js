...
var donatePage = {
    ...
    init: function () {
        ...
        $("#approveBtnNISBils").click(function () {
            if (!donateBtnClicked) {
                donateBtnClicked = true;

                if (balanceSumValue == 0) {
                    var title = 'Erorr';
                    var msg = 'The box is empty, please drag money and try again.';
                    var btnLabel = 'Confirm';
                    navigator.notification.alert(
                        msg,
                        null,         // callback
    ...
    setSize: function () {
        ...
        if ($('#coin_0_5.shekelBills').length > 0) {
            $('#coin_0_5.shekelBills').css('top', '50%');
        }
        if ($('#coin_10.shekelBills').length > 0) {
            $('#coin_10.shekelBills').css('top', '50%');
        }
